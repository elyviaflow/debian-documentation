...
If the configuration was successful, the network interface and IP address configuration should appear as shown in the image provided. The setup process is now complete.<br/>
